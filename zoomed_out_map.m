%% zoomed out map to show study area
% started 4/21/23
...
% m_gshhs_l('patch','k','edgecolor','k') % low resolution land patch (increase resolution if zooming in to small area by switching to m_gshhs_i, m_gshhs_h, or m_gshhs_f)
% m_grid('ytick',[90 85 80 75 70],'fontsize',16);
m_grid('ytick',[],'yticklabels',[]);
m_grid('xtick',[],'yticklabels',[]);
