function [ map_fig ] = ortho_map_ESS(r)
...
m_proj('stereographic','lat',90,'long',300,'radius',r); % stereographic projection
...
% land patch and grid
m_gshhs_l('patch',[.7,.7,.7],'edgecolor','k') % low resolution land patch (increase resolution if zooming in to small area by switching to m_gshhs_i, m_gshhs_h, or m_gshhs_f)
