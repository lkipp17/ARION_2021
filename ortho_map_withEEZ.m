function [ map_fig ] = ortho_map_withEEZ(r)
...
% Russian EEZ already has lon converted into negative. Use code below if want to switch to all-Arctic EEZ, 
% which does not have converted lon
% for ii=1:length(EEZ_lon)
%    if EEZ_lon(ii)>0
%        EEZ_lon(ii) = EEZ_lon(ii) - 360;
%    elseif EEZ_lon(ii) == EEZ_lon(ii)
%    end
% end
